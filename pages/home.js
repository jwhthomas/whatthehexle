  ...
  function handleSpecial(keyPressed){
    ...
    if(keyPressed === "ENTER"){
      ...
      userInput.forEach((e, count) => {
        ...
        // if(e === hexCode[count] && hexCode[count] !== "X"){
        //   hexCode[count] = "X";
        //   return document.getElementById("row"+currentRow+"box"+count).style.backgroundColor = "#00FF00"
        // }
        // if(hexCode.includes(userInput[count] && hexCode[count] !== "X")){
        //   hexCode[count] = "X";
        ...
        if(e === hexCode[count]){
          ...
          // hexCode[hexCode.findIndex(hexCode[count])] = "X"
          // hexCode = (hexCode.toString()[count] = "X").split()
          console.log(hexCode)
          return
        }
        if(!hexCode.includes(userInput[count])){
          ...
          return el.style.backgroundColor = "#FFA500"
        }
        console.log(hexCode)
      })
